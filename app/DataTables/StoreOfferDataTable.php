...
use Auth;
class StoreOfferDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'store_offers.datatables_actions')
    ...
    {
        $model=Offer::where('store_id', Store::where('user_id',Auth::user()->id)->first()->id );
