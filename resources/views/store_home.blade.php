            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box" style="border-top: 3px solid #5197BE;">
                        ...
                        <div class="box-footer text-center">
                            <a href="{{route('storeProducts.index')}}" class="uppercase">عرض المنتجات</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!-- /.box -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="box" style="border-top: 3px solid #5197BE;">
                        ...
                        <div class="box-body">
                            <ul class="products-list product-list-in-box">
                                @foreach($latest_offers as $offer)
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="{{url('uploads/images/'.$offer->product->img)}}" alt="Product Image">
                                        </div>  
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title"> المنتج : {{$offer->product->productLangs->where('lang_id','2')->first()->name}}
                                            </a>
                        ...
                        <!-- /.box-body -->
                        <div class="box-footer text-center">
                            <a href="{{route('storeOffers.index')}}" class="uppercase">عرض العروض</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!-- /.box -->
