                ...
                <div class="panel panel-primary" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input required class="form-control" name="question_ar" type="text" id="name" value= "{{$questionAr ??''}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ((\Request::is('questionRates/create')))
                                ...
                                <div class="input-group control-group increment" >
                                    <input required type="text" name="answer_ar[]" class="form-control">
                            ...
                            <div style="margin-top: 10px;" class="input-group control-group increment answer-{{$answer->id}}"  data-id="{{$answer->id}}" >
                                        <input required type="text" name="answer_ar[]" value="{{ $answer->qusetionRateAnswerLangs->where('lang_id','2')->first()->answer }}" class="form-control">
        ...
        <div class="col-md-8  admin-content" id="English">
            ...
            <div class="panel panel-primary" style="margin: 1em;">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input required class="form-control" name="question_en" type="text" id="name" value= "{{$questionEn ??''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10 answersList">
                          ...
                          @if ((\Request::is('questionRates/create')))
                            ...
                            <div class="input-group control-group increment" >
                                <input required type="text" name="answer_en[]" class="form-control" >
                                <div class="input-group-btn "> 
                                <button style="margin-right:10px;" class="btn btn-success" type="button"><i class="glyphicon glyphicon-plus"></i></button>
                                </div>
                            </div>
                     ...
                     @if (!(\Request::is('questionRates/create')))
                          ...
                          @foreach ($questionRate->qusetionRateAnswers as $answer )
                            ...
                            <div style="margin-top: 10px;" class="input-group control-group increment answer-{{$answer->id}}"  data-id="{{$answer->id}}" >
                                <input required type="text" name="answer_en[]" value="{{ $answer->qusetionRateAnswerLangs->where('lang_id','1')->first()->answer }}" class="form-control">
